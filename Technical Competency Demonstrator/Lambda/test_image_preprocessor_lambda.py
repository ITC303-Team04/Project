...
class TestPreProcessingLambda(unittest.TestCase):
    ...
    @patch(
        "image_preprocessor_lambda.get_bucket_names",
        return_value=(BUCKET_NAME, DEST_BUCKET_NAME),
    )
    @patch("image_preprocessor_lambda.process_image")
    @patch("image_preprocessor_lambda.get_file_from_bucket")
    @patch("image_preprocessor_lambda.add_file_to_bucket")
    @patch("image_preprocessor_lambda.remove_file_from_bucket")
